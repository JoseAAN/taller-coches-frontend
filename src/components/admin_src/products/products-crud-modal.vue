...
export default {
    ...
    methods: {
        ...
        submit() {
            ...
            // Dependiendo de tu backend, puede que espere un campo concreto para las imágenes.
            ...
            fetch(url, {
                ...
                .then(() => {
                    ...
                    const btnClose = document.querySelector("#productModal .btn-close");
                    if (btnClose) btnClose.click();
                })
                .catch(err => {
                    this.toast.error(err.message || "Ocurrió un error al guardar el producto.");
                    console.error(err);
                })
                .finally(() => {
                    loaderState.hide();
...
<style scoped>
/* Los mismos estilos que el modal de servicios con colores ajustados */
.text-area-icon {
    top: 14px;
}
